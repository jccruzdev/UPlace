...
public abstract class DeleteCallback extends  ItemTouchHelper.SimpleCallback{
    Context context;
    ...
    public DeleteCallback(Context context) {
        ...
        editIcon = ContextCompat.getDrawable(context,R.drawable.ic_baseline_delete_24);
